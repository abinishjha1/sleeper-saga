        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="order-2 md:order-1 animate-fade-in">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight">
              Step Into <span className="text-brand-700">Comfort</span> & <span className="text-brand-700">Style</span>
            </h1>
          ...
          <div className="order-1 md:order-2 relative">
            ...
            {/* Decorative elements */}
            <div className="absolute -bottom-6 -right-6 h-24 w-24 rounded-full bg-brand-200 -z-10"></div>
            <div className="absolute -top-6 -left-6 h-16 w-16 rounded-full bg-brand-300 -z-10"></div>
          </div>
        </div>
      </div>
    </section>
